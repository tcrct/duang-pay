...
public class AliPayApi {
	 ...
	 * @throws {IOException}
	 */
	public static String wapPay(AlipayTradeWapPayModel model, String returnUrl,
			String notifyUrl) throws AlipayApiException, IOException {
		// 直接将完整的表单html输出到页面
		return wapPayStr(model, returnUrl, notifyUrl);
	}
...
//	}
	...
	public static void batchTrans(Map<String, String> params, String privateKey, String signType) throws IOException {
		params.put("service", "batch_trans_notify");
		params.put("_input_charset", "UTF-8");
		params.put("pay_date", ToolsKit.formatDate(new Date(), "YYYYMMDD"));
