...
import com.duangframework.kit.HashKit;
...
public class AlipayCore {
	 ...
	 * @return 签名结果字符串
	 */
	public static String buildRequestSign(Map<String, String> params, String key, String signType) {
	...
	public static Map<String, String> buildRequestPara(Map<String, String> params, String key, String signType) {
		...
		// 生成签名结果
		String mysign = buildRequestSign(params, key, signType);
